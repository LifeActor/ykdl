...
class Pptv(VideoExtractor):
    ...
    def prepare(self):
        ...
        xml = get_content('http://web-play.pptv.com/webplay3-0-{}.xml?type=web.fpp'.format(self.vid))
        ...
        info.streams['current'] = {'container': 'mp4', 'video_profile': 'current', 'src' : urls, 'size': total_size}
