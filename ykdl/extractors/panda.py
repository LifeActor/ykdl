...
class Panda(VideoExtractor):
    ...
    live_base = "http://pl{}.live.panda.tv/live_panda/{}.flv"
    ...
    def prepare(self):
        ...
        info.streams['current'] = {'container': 'flv', 'video_profile': 'current', 'src' : [self.live_base.format(plflag, room_key)], 'size': float('inf')}
        return info
